...
public class ProjectsApp {
    ...
    private void updateProjectDetails() {
        ...
        Integer difficulty = getIntInput("Enter the project difficulty (1-5) [" + curProject.getEstimatedHours() + "]");
    ...
    // Restrieve a list of projects from projectService and print each project with
    // its ID and name
